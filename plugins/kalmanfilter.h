...
KalmanFilter *make_kalmanfilter();
void kalmanfilter_setup_notifiers(KalmanFilter *this);
void kalmanfilter_initialize(KalmanFilter *this);
void kalmanfilter_time_update(KalmanFilter *this);
gdouble kalmanfilter_get_estimated_value(KalmanFilter *this);
void kalmanfilter_measurement_update(KalmanFilter *this);
