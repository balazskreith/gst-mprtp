...
echo -n " "
echo -n "--path1_tx_rtp_port=5044 "
echo -n "--path1_tx_rtcp_port=5045 "
echo -n "--path1_rx_rtp_port=5046 "
echo -n "--path1_rx_rtcp_port=5047 " 
echo -n "--path2_tx_rtp_port=5048 "  
echo -n "--path2_tx_rtcp_port=5049 "  
echo -n "--path2_rx_rtp_port=5050 "  
echo -n "--path2_rx_rtcp_port=5051 "  
echo -n "--path3_tx_rtp_port=5052 "  
echo -n "--path3_tx_rtcp_port=5053 "  
echo -n "--path3_rx_rtp_port=5054 "  
echo -n "--path3_rx_rtcp_port=5055 "  
echo -n "--rtpbin_tx_rtcp_port=5056 "  
echo -n "--rtpbin_rx_rtcp_port=5057 "  
...
echo -n "--logging=1 "  
echo -n "--logsdir=scripts2/temp/peer4/ "      
