...
echo -n " "
echo -n "--path1_tx_rtp_port=5058 "
echo -n "--path1_tx_rtcp_port=5059 "
echo -n "--path1_rx_rtp_port=5060 "
echo -n "--path1_rx_rtcp_port=5061 " 
echo -n "--path2_tx_rtp_port=5062 "  
echo -n "--path2_tx_rtcp_port=5063 "  
echo -n "--path2_rx_rtp_port=5064 "  
echo -n "--path2_rx_rtcp_port=5065 "  
echo -n "--path3_tx_rtp_port=5066 "  
echo -n "--path3_tx_rtcp_port=5067 "  
echo -n "--path3_rx_rtp_port=5068 "  
echo -n "--path3_rx_rtcp_port=5069 "  
echo -n "--rtpbin_tx_rtcp_port=5070 "  
echo -n "--rtpbin_rx_rtcp_port=5071 "  
...
echo -n "--logging=1 "  
echo -n "--logsdir=scripts2/temp/peer5/ "      
