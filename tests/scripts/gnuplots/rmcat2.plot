...
plot statlogs  using ($0*0.1):(($4+$5)/125) with point pointtype 7 ps 0.2 lc rgb "blue" title "Sending Rate", \
	 statlogs2 using ($0*0.1):(($4+$5)/125) with point pointtype 7 ps 0.2 lc rgb "0x008c48" title "Sending Rate2", \
     statlogs using ($0*0.1):2 with lines lc rgb "0xDC143C" title "Path Capacity"
 

#statlogs using ($0*0.1):($8/1000) with point pointtype 3 ps 0.4 lc rgb "0xFF6347" title "Target bitrate"
