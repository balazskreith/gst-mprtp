    ...
    guint32 clockrate)
{
  ...
  g_object_set (async_tx_rtcpSrc_1,
                "port", path1_tx_rtcp_port,
                NULL);

  g_object_set (async_tx_rtcpSrc_2,
                "port",  path2_tx_rtcp_port,
                NULL);

  g_object_set (async_tx_rtcpSrc_3,
                "port",  path3_tx_rtcp_port,
                NULL);
  ...
  g_object_set (mprtpply,
                ...
                "lost-treshold", lost_th,
                "discard-treshold", discard_th,
                "spike-delay-treshold", spike_delay_th,
                "spike-var-treshold", spike_var_th,
                "owd-window-treshold", owd_th,
