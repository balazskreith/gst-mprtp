...
echo "./bcex $CONFDIR/mprtp4.cmds " > $LOGSDIR"/ntrt.sh"
echo "./bwcsv $LOGSDIR/pathbw_1.csv 1 3000 1200" >> $LOGSDIR"/ntrt.sh"
echo "./bwcsv $LOGSDIR/pathbw_2.csv 1 3000 1200" >> $LOGSDIR"/ntrt.sh"
echo "./$SCRIPTSDIR/runs/postproc/mprtp4.sh $alg $OWD_SND" >> $LOGSDIR"/ntrt.sh"
