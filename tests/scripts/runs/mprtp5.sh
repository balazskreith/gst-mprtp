...
echo "./bcex $CONFDIR/mprtp5.cmds " > $LOGSDIR"/ntrt.sh"
echo "./bwcsv $LOGSDIR/pathbw_1.csv 1 3000 3000" >> $LOGSDIR"/ntrt.sh"
echo "./bwcsv $LOGSDIR/pathbw_2.csv 1 3000 3000" >> $LOGSDIR"/ntrt.sh"
echo "./$SCRIPTSDIR/runs/postproc/mprtp5.sh $alg $OWD_SND" >> $LOGSDIR"/ntrt.sh"
