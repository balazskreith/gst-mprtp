...
plot statfile using ($0*0.1):(($8+$9)/125) with point pointtype 7 ps 0.3 lc rgb "0x008c48" title "Subflow 2 (SR + FEC)", \
	 statfile using ($0*0.1):($11/125) with point pointtype 7 ps 0.3 lc rgb "0xFF6347" title "TCP Rate"
...
plot statfile using ($0*0.1):(($4 - path_delay)/1000000) with point pointtype 7 ps 0.3 lc rgb "blue" title "Queue Delay for Path 1", \
     statfile using ($0*0.1):(($10 - path_delay)/1000000) with point pointtype 7 ps 0.3 lc rgb "0x008c48" title "Queue Delay for Path 2"
