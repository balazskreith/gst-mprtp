...
plot statfile using ($0*0.1):(($5+$6)/125) with point pointtype 7 ps 0.3 lc rgb "0x008c48" title "Sending Rate + FEC Rate 2", \
     statfile using ($0*0.1):4 with lines lc rgb "0xDC143C" title "Path Capacity"
...
set xtics font ", 26"
set xlabel "Time [s]" offset 0,-1.1 font ", 22"
plot statfile using ($0*0.1):($5/125) with point pointtype 7 ps 0.3 lc rgb "0x008c48" title "Sending Rate 2", \
     statfile using ($0*0.1):4 with lines lc rgb "0xDC143C" title "Path Capacity"
