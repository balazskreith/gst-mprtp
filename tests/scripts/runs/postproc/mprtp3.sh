...
PLTOFILE_FORWARDS=$LOGSDIR/$TEST"_"$CC"_"$DELAY"ms_forward.pdf"
PLTOFILE_BACKWARDS=$LOGSDIR/$TEST"_"$CC"_"$DELAY"ms_backward.pdf"
...
set -x
paste -d, $LOGSDIR/pathbw_forward_1.csv $LOGSDIR/sr_1_s1.csv $LOGSDIR/qmd_1_s1.csv \
  $LOGSDIR/pathbw_forward_2.csv $LOGSDIR/sr_1_s2.csv $LOGSDIR/qmd_1_s2.csv \
  $LOGSDIR/pathbw_backward_1.csv $LOGSDIR/sr_2_s1.csv $LOGSDIR/qmd_2_s1.csv \
  $LOGSDIR/pathbw_backward_2.csv $LOGSDIR/sr_2_s2.csv $LOGSDIR/qmd_2_s2.csv  > $LOGSDIR/plotstat.csv 

gnuplot -e "statfile='temp/plotstat.csv'" \
        -e "output_file='$PLTOFILE_FORWARDS'" \
        -e "path_delay='$PATH_DELAY'" \
        $SCRIPTSDIR/runs/plots/mprtp3_forward.plot
        
gnuplot -e "statfile='temp/plotstat.csv'" \
        -e "output_file='$PLTOFILE_BACKWARDS'" \
        -e "path_delay='$PATH_DELAY'" \
        $SCRIPTSDIR/runs/plots/mprtp3_backward.plot
        
gnuplot -e "statfile='temp/plotstat.csv'" \
        -e "output_file='$PLTOFILE_AGGR'" \
        -e "path_delay='$PATH_DELAY'" \
        $SCRIPTSDIR/runs/plots/mprtp3_aggr.plot
