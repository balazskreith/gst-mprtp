...
if (flownum == 1){
  plot throughput_file using ($0*0.1):($1/125) with lines ls 1 title "Sending Rate", \
       ...
       throughput_file using ($0*0.1):7 with lines ls 4 title "Path Capacity"
}

if (flownum == 2){
    plot throughput_file using ($0*0.1):(($1+$2)/125) with lines ls 1 title "Sending Rate", \
         throughput_file using ($0*0.1):(($3+$4)/125) with lines ls 2 title "Sending Rate 2", \
         throughput_file using ($0*0.1):7 with lines ls 4 title "Path Capacity"
}
...
if (flownum == 3){
    plot throughput_file using ($0*0.1):(($1+$2)/125) with lines ls 1 title "Sending Rate", \
         throughput_file using ($0*0.1):(($3+$4)/125) with lines ls 2 title "Sending Rate 2", \
         throughput_file using ($0*0.1):(($5+$6)/125) with lines ls 3 title "Sending Rate 2", \
         throughput_file using ($0*0.1):7 with lines ls 4 title "Path Capacity"
}